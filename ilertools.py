...
def discrete_random_1():
    """ События A, B и C имеют вероятности """
    def f():
        P_A = 0.1
        P_B = 0.4
        P_C = 0.3
...
def portfolio_analysis_1():
    """ Математическое ожидание доходности акций компаний A и B составляет """
    def f():
...
def portfolio_analysis_2():
    """ Инвестор сформировал портфель из акций команий A и B, """
    def f():
